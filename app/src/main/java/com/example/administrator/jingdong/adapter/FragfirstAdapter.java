...
public class FragfirstAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    private List<FenLeiBean.DataBean> list;
    private Context context;

    public FragfirstAdapter(List<FenLeiBean.DataBean> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        viewHolder.sdv.setImageURI(list.get(position).getIcon());
