 ...
 *
 */
public class wzb_gesturelockview2 extends RelativeLayout {

    private static final String TAG = "GestureLockViewGroup";
    /**
     * 保存所有的GestureLockView
     */
    private wzb_gesturelockview[] mGestureLockViews;
    /**
    ...
    public wzb_gesturelockview2(Context context, AttributeSet attrs) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mGestureLockViews == null) {
            mGestureLockViews = new wzb_gesturelockview[mCount * mCount];
            ...
            for (int i = 0; i < mGestureLockViews.length; i++) {
                ...
                mGestureLockViews[i] = new wzb_gesturelockview(getContext(),
                ...
                lockerParams.setMargins(leftMagin, topMargin, rightMargin,
                        bottomMargin);
                mGestureLockViews[i].setMode(wzb_gesturelockview.Mode.SSTATUS_NO_FINGER);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                mPaint.setAlpha(50);
                wzb_gesturelockview child = getChildIdByPos(x, y);
                if (child != null) {
                    int cId = child.getId();
                    if (!mChoose.contains(cId)) {
                        mChoose.add(cId);
                        child.setMode(wzb_gesturelockview.Mode.STATUS_FINGER_ON);
            ...
            case MotionEvent.ACTION_UP:
                ...
                for (int i = 0; i + 1 < mChoose.size(); i++) {
                    ...
                    wzb_gesturelockview startChild = (wzb_gesturelockview) findViewById(childId);
                    wzb_gesturelockview nextChild = (wzb_gesturelockview) findViewById(nextChildId);
    ...
    private void changeItemMode() {
        for (wzb_gesturelockview gestureLockView : mGestureLockViews) {
            if (mChoose.contains(gestureLockView.getId())) {
                gestureLockView.setMode(wzb_gesturelockview.Mode.STATUS_FINGER_ON);
            }
        }
    }
    ...
    private void reset() {
        ...
        mPath.reset();
        for (wzb_gesturelockview gestureLockView : mGestureLockViews) {
            gestureLockView.setMode(wzb_gesturelockview.Mode.SSTATUS_NO_FINGER);
     ...
     * @return
     */
    private wzb_gesturelockview getChildIdByPos(int x, int y) {
        for (wzb_gesturelockview gestureLockView : mGestureLockViews) {
