...
import com.example.administrator.jingdong.adapter.FragfirstAdapter;
...
public class FragmentFirst extends Fragment implements IFenLei_view {
    ...
    public void setcid(final List<FenLeiBean.DataBean> dataBean) {
        getActivity().runOnUiThread(new Runnable() {
            @Override
            public void run() {
                FragfirstAdapter adapter = new FragfirstAdapter(dataBean, getActivity());
