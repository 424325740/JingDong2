 ...
 */
public class wzb_gesturelockview extends View {
    private static final String TAG = "GestureLockView";

    //GestureLockView的三种状态
    enum Mode {
        SSTATUS_NO_FINGER, STATUS_FINGER_ON, STATUS_FINGER_UP;
    }

    //GestureLockView的当前状态
    private Mode mCurrentStatus = Mode.SSTATUS_NO_FINGER;
    //设置宽度
    private int mWidth;
    //设置高度
    private int mHeight;
    ...
    public wzb_gesturelockview(Context context, int colorNoFingerInner, int colorNoFingerOutter, int colorFingerOn, int colorFingerUp) {
        super(context);
